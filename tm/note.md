...
PYTHONPATH=.. nohup python train.py --symbol=btcusdt --kl_interval=4h --epochs=20 --seq_len=16 --model_type=encoder_decoder > out/logs/`date +%F`/med-`date +%H_%M`.nohup &
...
PYTHONPATH=.. python load_eval.py\
 --cp_file=out/artifacts/med/2023-07-01/ethusdt-4h-sl16-di34-dm1024-h8-b6x2-df1024-dg16_epoch-32.pt\
  --print_pred_detail --model_type=encoder_decoder\
  --cached_batch_base_dir="../data/tm/batch_tensor_val_m3_9"
  --eval_batch --save_graph --export_onnx --show_state_dict\

PYTHONPATH=.. python load_eval.py --cp_file=out/artifacts/mdo/ethusdt-4h-sl32-di34-dm1024-h8-b12-df1024-dg16_final.pt --model_type=decoder_only -- --interactive
